# Script para verificar se o atalho foi criado no OneDrive
$shortcutPath = "$env:USERPROFILE\OneDrive\Desktop\Sistema de Estoque.lnk"
...
if (Test-Path $shortcutPath) {
    ...
    if (Test-Path $shortcut.TargetPath) {
        Write-Host "  O arquivo de destino existe!" -ForegroundColor Green
    } else {
        Write-Host "  O arquivo de destino não existe!" -ForegroundColor Red
    }
} else {
